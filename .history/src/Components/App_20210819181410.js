    ...
    return (
      <div>
        <nav className="navbar navbar-light bg-light">
          ...
          <img src="https://www.shutterstock.com/tr/image-vector/penguin-vector-logo-design-icon-symbol-1591885750" alt="" width="40" height="35" class="d-inline-block align-text-top"/>
           BOOKS
    </a>
