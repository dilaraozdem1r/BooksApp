...
class Admin extends React.Component {
  ...
  <header class="container h-100">
    ...
    <div class="d-flex align-items-center justify-content-center h-100">
                ...
                <div className="col">
                <div className="container"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZ-o86obF-UTdLqsqqiUM6O82URx7R52fXlw&usqp=CAU" alt="" width="100" height="100" class="d-inline-block align-text-top"/>
                </div>
                    <form>
