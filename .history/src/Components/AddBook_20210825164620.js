...
class AddBook extends React.Component{
    ...
    check=()=>{
        if(this.name && this.author && this.overview) this.setState({control : false});
    ...
    render(){
        return(
            ...
            <input className="form-control" id="disabledInput" type="text" placeholder="Fill The Form To Add A Book.." disabled/>
                ...
                <input type="submit" className="btn btn-danger btn-block" value="Add Book" disabled={this.state.control}/>
            </form>
        </div>
        )
    }
