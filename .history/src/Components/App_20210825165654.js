...
class App extends React.Component {
  ...
  editBook=async(id,updatedBook)=>{
    axios.put(`http://localhost:3004/books/${id,updatedBook}`)
    this.getBook();
                ...
                <nav className="navbar navbar-light bg-light">
                  <div className="container-fluid">
                    <a className="navbar-brand">
                      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZ-o86obF-UTdLqsqqiUM6O82URx7R52fXlw&usqp=CAU" alt="" width="50" height="40" className="d-inline-block align-text-top" />
                    </a>
