    ...
    return (
      <div>
        <nav className="navbar navbar-light bg-light">
          ...
          <img src="https://img.freepik.com/free-vector/cute-penguin-wearing-earmuff-cartoon-character_138676-2917.jpg?size=338&ext=jpg" alt="" width="40" height="35" class="d-inline-block align-text-top"/>
           BOOKS
    </a>
